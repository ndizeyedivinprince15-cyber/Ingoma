...
exports.getRegionFromDepartment = getRegionFromDepartment;
exports.getDepartmentFromPostalCode = getDepartmentFromPostalCode;
/**
 ...
 */
function getRegionFromDepartment(departmentCode) {
    for (const [region, departments] of Object.entries(exports.REGIONS)) {
...
function getDepartmentFromPostalCode(postalCode) {
    if (postalCode.startsWith('20')) {
        // Corse : 20000-20190 = 2A, 20200-20290 = 2B
